...
class Order(models.Model):
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True)
    paymentMethod = models.CharField(max_length=40, null=True, blank=True)
...
class OrderItem(models.Model):
    ...
    name = models.CharField(max_length=40, null=True, blank=True)
    quality = models.IntegerField(null=True, blank=True, default=0)
    price = models.DecimalField(max_digits=8, decimal_places=2)
...
class ShippingAddress(models.Model):
    ...
    postalCode = models.CharField(max_length=40, null=True, blank=True)
    country = models.CharField(max_length=40, null=True, blank=True)
    shippingPrice = models.DateTimeField(auto_now_add=False, null=True, blank=True)
